...
{/foreach}
{if !$readonly}
    <a href="create.php" class="btn btn-outline-primary btn-sm w-100 mt-2">+ New machine</a>
{/if}
  </div>
  ...
  <div class="card-footer">
    <form method="post" action="logout.php" class="m-0">
      ...
      <button type="submit" class="btn btn-link btn-sm p-0 float-end">Logout</button>
    </form>
  </div>
</div>
