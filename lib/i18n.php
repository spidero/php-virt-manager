...
const I18N_DYNAMIC = [
    ...
    'Cloning', 'Image download', 'Machine from cloud image', 'Hard disk', 'CD/DVD', 'Network (PXE)', 'Rebooting machine, it may take some time', 'Suspending machine', 'Resuming machine',
];
